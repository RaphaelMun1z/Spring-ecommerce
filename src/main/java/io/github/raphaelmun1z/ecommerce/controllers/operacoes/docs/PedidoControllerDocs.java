...
public interface PedidoControllerDocs {
    ...
    ResponseEntity<PedidoResponseDTO> buscarPorId(
    ...
    ResponseEntity<Page<PedidoResponseDTO>> listarPorCliente(
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Status atualizado com sucesso", content = @Content(schema = @Schema(implementation = PedidoResponseDTO.class))),
