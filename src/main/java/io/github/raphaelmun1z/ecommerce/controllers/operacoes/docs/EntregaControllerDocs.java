...
public interface EntregaControllerDocs {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Entrega encontrada", content = @Content(schema = @Schema(implementation = EntregaResponseDTO.class))),
        @ApiResponse(responseCode = "404", description = "Entrega não encontrada", content = @Content)
    })
    ResponseEntity<EntregaResponseDTO> buscarPorId(
    ...
    ResponseEntity<EntregaResponseDTO> buscarPorPedido(
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Entrega criada com sucesso", content = @Content(schema = @Schema(implementation = EntregaResponseDTO.class))),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Rastreio atualizado com sucesso", content = @Content(schema = @Schema(implementation = EntregaResponseDTO.class))),
        @ApiResponse(responseCode = "400", description = "Não é possível alterar entrega finalizada", content = @Content),
        @ApiResponse(responseCode = "404", description = "Entrega não encontrada", content = @Content)
    })
    ResponseEntity<EntregaResponseDTO> atualizarRastreio(
        @Parameter(description = "ID da entrega") @PathVariable String id,
    ...
    @ApiResponse(responseCode = "200", description = "Status atualizado com sucesso", content = @Content(schema = @Schema(implementation = EntregaResponseDTO.class)))
    ResponseEntity<EntregaResponseDTO> atualizarStatus(
        @Parameter(description = "ID da entrega") @PathVariable String id,
    ...
    @ApiResponse(responseCode = "200", description = "Entrega confirmada com sucesso", content = @Content(schema = @Schema(implementation = EntregaResponseDTO.class)))
    ResponseEntity<EntregaResponseDTO> confirmarEntrega(
        @Parameter(description = "ID da entrega") @PathVariable String id
    );
}